...
def elevation_B(update_elevator_B):
    """Docstring: Every subroutine and function has a docstring."""
    #  gatekeeper, richtige eingaben

    direction = update_elevator_B[0]
    status = update_elevator_B[1]
    goal = update_elevator_B[2]
    list_order = update_elevator_B[3]
    list_output = []
