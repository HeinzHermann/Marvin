...
class EvalFile:
    """ class to read a file and calculate statistics """

    def get_file(self):
        """ Class method which elects file through tk fileopen dialog """

        # open file dialog to enable user to choose file path
        root = tk.Tk()
        ...
        self.file_in = os.path.basename(self.filename)
        self.path_in = self.filename


    def read_file(self):
        """ class method, reads a file in different encodings"""
