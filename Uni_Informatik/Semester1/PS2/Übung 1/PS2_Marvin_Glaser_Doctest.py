...
def main():
    ...
    >>> runner.gatekeeper('19120725')
    True
    >>> convert = dater()
    >>> for to_print in convert.dateconvert('19120725'):
    ...     print(to_print)
    ...
    >>> runner = user_interface()
    >>> runner.gatekeeper('18010101')
    True
    >>> convert = dater()
    >>> for to_print in convert.dateconvert('18010101'):
    ...     print(to_print)
    ...
    >>> runner = user_interface()
    >>> runner.gatekeeper('22001231')
    True
    >>> convert = dater()
    >>> for to_print in convert.dateconvert('22001231'):
    ...     print(to_print)
    Mittwoch, 31. Dezember 2200
    Wednesday, 31 December 2200
    Wednesday, 12/31/2200
    7289611200
    
    >>> runner = user_interface()
    >>> runner.gatekeeper('18001231')
    <BLANKLINE>
    Sorry, but it appears that your input year is outisidethe given range (1801 - 2200)
    Please check your input and adjust it to your chosen format
    False
    
    >>> runner = user_interface()
    >>> runner.gatekeeper('22010101')
    <BLANKLINE>
    Sorry, but it appears that your input year is outisidethe given range (1801 - 2200)
    Please check your input and adjust it to your chosen format
    False
    ...
    M2 doctests (3a - 3e):
    >>> runner = user_interface()
    >>> runner.date_prepare('07/25/1912')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('19120725')
    True
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('01/01/1801')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('18010101')
    True
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('12/31/2200')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('22001231')
    True
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('12/31/1800')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('18001231')
    <BLANKLINE>
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('01/01/2201')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('22010101')
    <BLANKLINE>
    ...
    M1 doctest (4a - 4c):
    >>> runner = user_interface()
    >>> runner.gatekeeper('19A20725')
    <BLANKLINE>
    Sorry, but it appears that your input for YYYY contianed other symbols than numbers
    Please check your input and adjust it to your chosen format
    False

    >>> runner = user_interface()
    >>> runner.gatekeeper('1912A725')
    <BLANKLINE>
    Sorry, but it appears that your input for MM contianed other symbols than numbers
    Please check your input and adjust it to your chosen format
    False
    
    >>> runner = user_interface()
    >>> runner.gatekeeper('191207A5')
    <BLANKLINE>
    Sorry, but it appears that your input for DD contianed other symbols than numbers
    Please check your input and adjust it to your chosen format
    False
    ...
    M2 doctest (5a - 5c):
    >>> runner = user_interface()
    >>> runner.date_prepare('07/25/19A2')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('19A20725')
    <BLANKLINE>
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('A7/25/1912')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('1912A725')
    <BLANKLINE>
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('07/A5/1912')
    True
    >>> runner = user_interface()
    >>> runner.gatekeeper('191207A5')
    <BLANKLINE>
    ...
    M2 doctest (7a - 7f):
    >>> runner = user_interface()
    >>> runner.date_prepare('07/25/19125')
    <BLANKLINE>
    Sorry, but the string you entered was to long
    Please check your input and adjust it to your chosen format
    False
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('007/25/1912')
    <BLANKLINE>
    Sorry, but the string you entered was to long
    Please check your input and adjust it to your chosen format
    False
    ...
    >>> runner = user_interface()
    >>> runner.date_prepare('07/025/1912')
    <BLANKLINE>
    Sorry, but the string you entered was to long
    Please check your input and adjust it to your chosen format
    False
